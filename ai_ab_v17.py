"""v17: v16 + staged interior-node move ordering.
...
- **Interior nodes**: staged generation via move_ordering.staged_interior_moves()
  with placement quota (K=2-6 by depth), class-priority ordering,
  killer moves, and history heuristic for intra-class tiebreaking.

The staged approach prevents placement flooding of MOVE_CAP while still
admitting a few high-quality placements at each interior node.
"""
import time
import random
import threading
